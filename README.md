...
## claude code
해당 프로젝트는 claude code를 통해 생성한 prd 기반 개발 테스트을 위해 생성한 프로젝트입니다.<br/>
**개발기한**: 04.04~ 04.05
...
| 역할         | 기술                          | 선정 이유                                                    | 비고                                                             |
| ---------- | --------------------------- | -------------------------------------------------------- | -------------------------------------------------------------- |
| 편집기        | Obsidian                    | 평소 즐겨쓰는 메모Tool이고 팀블로그가 아니라 개인 블로그라서 선정                   |                                                                |
| 정적 사이트 생성기 | Quartz 4                    | 태생이 Obsidian을 웹사이트 형태로 게시하기 위한 도구로 설계됨                   | [문서](https://quartz.jzhao.xyz/features/Obsidian-compatibility) |
