...
| 정적 사이트 생성기 | Quartz 4                    | 태생이 Obsidian을 웹사이트 형태로 <br>게시하기 위한 도구로 설계됨               | [문서](https://quartz.jzhao.xyz/features/Obsidian-compatibility) |
...
EC2 + Nginx + 서버 사용 안한 이유는<br/>블로그는 지속성이 있어야한다고 생각해서 돈이 안나가는 방향으로 설계
